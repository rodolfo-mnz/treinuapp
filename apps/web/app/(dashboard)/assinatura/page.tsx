  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {planos?.map((plano) => {
          const features: string[] = Array.isArray(plano.features)
            ? plano.features as string[]
            : []
          ...
          return (
            <div
              ...
              className={`bg-white rounded-xl border p-6 ${
                isAtual ? "border-blue-500 ring-1 ring-blue-500" : "border-gray-200"
              }`}
            >
              {isAtual && (
              ...
              {plano.max_alunos && (
                <p className="text-sm text-gray-500 mt-1">Até {plano.max_alunos} alunos</p>
              )}
              {!plano.max_alunos && (
                <p className="text-sm text-gray-500 mt-1">Alunos ilimitados</p>
              )}
